...
function SoundManager(smURL,smID) {
  ...
  this.useMovieStar = false;	   // enable support for Flash 9.0r115+ (codename "MovieStar") MPEG4 video formats (M4V, FLV, MOV etc.)
  ...
  this.defaultOptions = {
    ...
    'isMovieStar': null			   // Flash 9 "MovieStar" support. Null (default) = auto detect based on URL. true = force on, ignore URL 
  };
  ...
  var _s = this; 
  this.version = null;
  this.versionNumber = 'V2.80a.20081005';
  this.movieURL = null;
  this.url = null;
  this.altURL = null;
  ...
  this.netStreamTypes = ['flv','mov','mp4','m4v','f4v','m4a','mp4v','3gp','3g2']; // Flash v9.0r115+ "moviestar" formats
  ...
  this.createSound = function(oOptions) {
    ...
    if (_s.flashVersion == 8) {
      ...
      _s.o._createSound(_tO.id,_tO.url,_tO.onjustbeforefinishtime,_tO.usePeakData,_tO.useWaveformData,_tO.useEQData,_tO.isMovieStar);
    };
...
soundManager.url = '/javascript-bundle/soundmanager/2.8.0/';
